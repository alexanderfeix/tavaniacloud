...
import de.cuelex.main.TavaniaClient;
import de.cuelex.server.TavaniaServer;
...
public class NettyServerHandler extends SimpleChannelInboundHandler<String> {
    ...
    public void handlerAdded(ChannelHandlerContext ctx) throws Exception {
        ...
        new TavaniaServer(0, incoming.localAddress().toString(), "TestServer", "Germany", TavaniaClient.getInstance().getGregorianDate().toString());
    }
    ...
    public void handlerRemoved(ChannelHandlerContext ctx) throws Exception {
        ...
        TavaniaServer tavaniaServer = TavaniaServer.serverIpAddress.get(incoming.localAddress().toString());
        TavaniaServer.serverId.remove(tavaniaServer.getId());
        TavaniaServer.serverIpAddress.remove(tavaniaServer.getIpAddress());
